...
logger.add("debug_sse.log", filter=lambda r: "[SSE]" in r.get("message", "") or "[SSE-DEBUG]" in r.get("message", "") or "[Inspector-DEBUG]" in r.get("message", "") or "[handoff检查]" in r.get("message", "") or "[match-detail]" in r.get("message", "") or "[match]" in r.get("message", "") or "[classify]" in r.get("message", "") or "[direct_execute]" in r.get("message", "") or "[route]" in r.get("message", "") or "[run_debug]" in r.get("message", "") or "[run]" in r.get("message", "") or "[llm_generate]" in r.get("message", "") or "[ChromaDB]" in r.get("message", ""), rotation="1 MB")
logger.add("debug_modify.log", filter=lambda r: "[modify_skill]" in r.get("message", ""), rotation="5 MB")
